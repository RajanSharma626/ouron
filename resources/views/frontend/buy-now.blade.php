                ...
                <div class="col-md-6">
                    ...
                    <div class="card custom-card-bg mb-4 check_product">
                        <div class="card-body pb-0">
                            ...
                            @else
                                <a href="{{ route('product.detail', $product->slug) }}" class="link-normal">
                                    <div class="d-flex align-items-center pb-3">
                                        <div class="position-relative">
                                            <img src="{{ $product->firstImage->img }}" alt="Product"
                                        ...
                                        <div class="d-flex justify-content-between w-100 ms-2">
                                            <div>
                                                <h6 class="mb-1 fw-bold check_title">{{ $product->name }}</h6>
                                            ...
                                            <div class="ml-auto">
                                                <h6>₹{{ number_format($product->discount_price, 2) }}
                                                </h6>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="card custom-card-bg">
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('buy.now.store') }}">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            <input type="text"
                                                class="form-control py-2 custom-card-bg @error('first_name') is-invalid @enderror"
                                ...
                                <div class="form-group mb-3">
                                    <input type="email"
                                        class="form-control py-2 custom-card-bg @error('email') is-invalid @enderror"
                                        name="email" id="emailAddress" placeholder="Enter email *"
                                ...
                                <div class="form-group mb-3">
                                    <input type="text"
                                        class="form-control py-2 custom-card-bg @error('address') is-invalid @enderror"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            <input type="text"
                                                class="form-control py-2 custom-card-bg @error('city') is-invalid @enderror"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            <select id="state"
                                                class="form-control py-2 custom-card-bg @error('state') is-invalid @enderror"
                                                name="state">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text"
                                                class="form-control py-2 custom-card-bg @error('pin_code') is-invalid @enderror"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            <input type="number"
                                                class="form-control py-2 custom-card-bg @error('phone') is-invalid @enderror"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group mb-3">
                                            <select
                                                class="form-control py-2 custom-card-bg @error('payment_method') is-invalid @enderror"
                                                name="payment_method">
...
@section('scripts')
    <script>
        document.getElementById('button-addon2').addEventListener('click', function(event) {
            ...
            fetch("{{ route('checkout.buy.applyCoupon') }}", {
                    method: "POST",
                    headers: {
                ...
                .then(data => {
                    if (data.error) {
                        ...
                        alert(data.message);
                        location.reload(); // Reload the page to reflect updated calculations
                    }
                })
                .catch(error => console.log(error));
        });

        document.querySelectorAll('form[action="{{ route('checkout.removeCoupon') }}"]').forEach(form => {
