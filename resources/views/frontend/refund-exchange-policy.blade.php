                ...
                <div class="col-12 policy-content">
                    ...
                    <ul class="mb-5">
                        ...
                        <li class="">
                            <small>
                                ...
                                The product or packaging was damaged during shipping.
                            </small>
                        </li>
                        <li class="">
                            <small>
                    ...
                    <ul class="mb-5">
                        <li class="">
                            <small>
                                ...
                                Be unused, undamaged, and in original condition.
                            </small>
                        </li>
                        <li class="">
                            <small>

                                Have all brand tags, packaging, and accessories intact.
                            </small>
                        </li>
                        <li class="">
                            <small>

                                Have no stains, scratches, tears, or any signs of wear.
                            </small>
                        </li>
                        <li class="">
                            <small>

                                Be returned as a full set (if purchased as a set).
                            </small>
                        </li>
                    </ul>
                    ...
                    <p>
                        <small>
                            ...
                            For any queries related to returns, refunds, or exchanges, contact us at:
                        </small>
                    </p>
                    <ul class="mb-5 list">
                        <li class="">
